...
export const FIXTURE_MEMBERS: TrackMember[] = [
  { id: 'mem-amara', name: 'Amara Okafor', email: 'amara@example.com', role: 'owner', avatar_url: '' },
  { id: 'mem-jonas', name: 'Jonas Weber', email: 'jonas@example.com', role: 'member', avatar_url: '' },
  { id: 'mem-priya', name: 'Priya Sharma', email: 'priya@example.com', role: 'member', avatar_url: '' },
  { id: 'mem-tomas', name: 'Tomás Rivera', email: 'tomas@example.com', role: 'member', avatar_url: '' },
]
...
export const FIXTURE_ISSUES: TrackIssue[] = [
  {
    ...
    status: 'in_progress', priority: 1, assignee_id: 'mem-jonas', creator_id: 'mem-amara',
  ...
  },
  {
    ...
    status: 'in_review', priority: 2, assignee_id: 'mem-priya', creator_id: 'mem-jonas',
  ...
  },
  {
    ...
    status: 'todo', priority: 3, assignee_id: 'mem-jonas', creator_id: 'mem-amara',
  ...
  },
  {
    ...
    status: 'backlog', priority: 4, creator_id: 'mem-priya',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'done', priority: 3, assignee_id: 'mem-tomas', creator_id: 'mem-tomas',
  ...
  },
  {
    ...
    status: 'backlog', priority: 0, creator_id: 'mem-amara',
  ...
  },
  {
    ...
    status: 'in_progress', priority: 2, assignee_id: 'mem-tomas', creator_id: 'mem-jonas',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'cancelled', priority: 3, assignee_id: 'mem-priya', creator_id: 'mem-priya',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'in_progress', priority: 1, assignee_id: 'mem-amara', creator_id: 'mem-amara',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'todo', priority: 2, assignee_id: 'mem-amara', creator_id: 'mem-amara',
  ...
  },
  {
    ...
    status: 'done', priority: 3, assignee_id: 'mem-jonas', creator_id: 'mem-amara',
  ...
  },
  {
    ...
    status: 'backlog', priority: 4, creator_id: 'mem-tomas',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'in_review', priority: 2, assignee_id: 'mem-tomas', creator_id: 'mem-jonas',
    lens_feature: '', ai_cost_usd: 0, ai_tokens: 0,
  ...
  },
  {
    ...
    status: 'done', priority: 2, assignee_id: 'mem-priya', creator_id: 'mem-priya',
...
export const FIXTURE_COMMENTS: TrackComment[] = [
  { id: 'com-1', issue_id: 'iss-1', author_id: 'mem-amara', body: 'Repro confirmed on a clean deploy — window is 2.4s on the staging VM. The health probe interval is the whole story.', created_at: iso(15, 10, 2), updated_at: iso(15, 10, 2) },
  { id: 'com-2', issue_id: 'iss-1', author_id: 'mem-jonas', body: 'Queueing beats 503 here: the pool is guaranteed non-empty within one probe tick, so a 250ms hold absorbs the whole window.', created_at: iso(16, 9, 41), updated_at: iso(16, 9, 41) },
  { id: 'com-3', issue_id: 'iss-1', author_id: 'mem-priya', body: 'Careful with the hold: the client SDK retries on 502 already. Queue + retry stacks to ~4s worst case.', edited_at: iso(16, 12, 0), created_at: iso(16, 11, 48), updated_at: iso(16, 12, 0) },
  { id: 'com-4', issue_id: 'iss-2', author_id: 'mem-amara', body: 'The error body is shared with three other gates — adding a URL there means adding it everywhere or special-casing. Leaning special-case.', created_at: iso(18, 15, 22), updated_at: iso(18, 15, 22) },
  { id: 'com-5', issue_id: 'iss-9', author_id: 'mem-jonas', body: 'Dual-secret window verified in staging; both secrets validate for the overlap. Cutover doc drafted.', created_at: iso(21, 11, 28), updated_at: iso(21, 11, 28) },
]
