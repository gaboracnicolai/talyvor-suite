 ...
 *
 * "It is applied at the call site" is true and is the whole problem: 43 uppercase class lists in
 ...
 *
 * `uppercase` (43 class lists apply it) and `normal-case` (1) are spelled out because the product
