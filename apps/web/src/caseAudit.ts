 ...
 *
 * "It is applied at the call site" is true and is the whole problem: 44 uppercase class lists in
 ...
 *
 * `uppercase` (44 class lists apply it) and `normal-case` (1) are spelled out because the product
