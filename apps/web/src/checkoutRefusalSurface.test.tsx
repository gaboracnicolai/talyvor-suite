...
// IssueList.tsx:428/390 all have that shape, each with a fallback. TopUp was the only surface
...
// redirect (TopUp.tsx:28, apps/bff/billing.go:290), so a call that never completed cannot
// have charged anyone.
...
describe('/billing — a checkout that never got an answer', () => {
  ...
  // depends on — and TopUp.tsx:316 states the rule: written only once the session exists, so a
