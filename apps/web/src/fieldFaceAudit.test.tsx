...
describe('what declares itself numeric', () => {
  it('an inputMode of decimal does — this is ConvertLens.tsx:129', () => {
  ...
  // slider Landing.tsx:291 actually ships declares NO inputMode, so it never reaches the exemption
