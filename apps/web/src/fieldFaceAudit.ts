 ...
 *         ConvertLens.tsx:136 — audited by Convert.test.tsx and Held.test.tsx.  onFace=FALSE
 ...
 * placeholderAudit both give: `ConvertLens.tsx:136` writes `inputMode` on `<Input>`, a component
