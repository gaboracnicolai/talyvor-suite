 ...
 *         ConvertLens.tsx:148 — audited by Convert.test.tsx and Held.test.tsx.  onFace=FALSE
 ...
 * placeholderAudit both give: `ConvertLens.tsx:148` writes `inputMode` on `<Input>`, a component
