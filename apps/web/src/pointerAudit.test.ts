 ...
 * checked from here; it says in the same breath that `apps/bff/lens.go:404` and
...
const PINS: Record<string, Pin> = {
  ...
  'apps/web/src/areas/lens/spendWindowCeiling.test.tsx:16|apps/bff/lens.go:404': {
    kind: 'LIVE',
  ...
  'apps/web/src/upstreamCitations.test.ts:55|apps/bff/lens.go:404': {
    kind: 'LIVE',
    fragment: 'clampInt(r.URL.Query().Get("limit"), 20, 1, 200)',
