...
const PINS: Record<string, Pin> = {
  'apps/web/src/eyebrowAudit.ts:25|apps/web/src/areas/lens/Overview.tsx:181': {
    kind: 'LIVE',
  ...
  'apps/web/src/PanelReportsItsOwnQuery.test.tsx:303|apps/web/src/areas/lens/Overview.tsx:264': {
    kind: 'LIVE',
