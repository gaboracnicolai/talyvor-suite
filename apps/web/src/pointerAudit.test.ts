...
const PINS: Record<string, Pin> = {
  ...
  'apps/web/src/areas/track/IssueDetail.tsx:140|apps/web/src/areas/track/IssueList.tsx:282': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/spendWindowCeiling.test.tsx:16|apps/bff/lens.go:478': {
    kind: 'LIVE',
  ...
  'apps/web/src/upstreamCitations.test.ts:55|apps/bff/lens.go:478': {
    kind: 'LIVE',
    fragment: 'clampInt(r.URL.Query().Get("limit"), 20, 1, 200)',
  ...
  'apps/web/src/areas/lens/Members.tsx:76|apps/bff/lens.go:672': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/Members.test.tsx:185|apps/bff/lens.go:672': {
    kind: 'LIVE',
    fragment: 'X-User-Email',
