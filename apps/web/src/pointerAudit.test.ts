...
const PINS: Record<string, Pin> = {
  'apps/web/src/eyebrowAudit.ts:25|apps/web/src/areas/lens/Overview.tsx:201': {
    kind: 'LIVE',
  ...
  'apps/web/src/PanelReportsItsOwnQuery.test.tsx:28|apps/web/src/areas/lens/Overview.tsx:304': {
    kind: 'LIVE',
  ...
  'apps/web/src/PanelReportsItsOwnQuery.test.tsx:303|apps/web/src/areas/lens/Overview.tsx:304': {
    kind: 'LIVE',
