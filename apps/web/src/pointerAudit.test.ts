...
const PINS: Record<string, Pin> = {
  ...
  'apps/web/src/checkoutRefusalSurface.test.tsx:59|apps/web/src/App.tsx:51': {
    kind: 'LIVE',
    fragment: 'onError',
  ...
  'apps/web/src/areas/lens/spendWindowCeiling.test.tsx:16|apps/bff/lens.go:533': {
    kind: 'LIVE',
  ...
  'apps/web/src/upstreamCitations.test.ts:55|apps/bff/lens.go:533': {
    kind: 'LIVE',
    fragment: 'clampInt(r.URL.Query().Get("limit"), 20, 1, 200)',
  ...
  'apps/web/src/areas/lens/Members.tsx:76|apps/bff/lens.go:785': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/Members.test.tsx:185|apps/bff/lens.go:785': {
    kind: 'LIVE',
    fragment: 'X-User-Email',
