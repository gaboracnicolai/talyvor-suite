...
const PINS: Record<string, Pin> = {
  ...
  'apps/web/src/checkoutRefusalSurface.test.tsx:65|apps/bff/billing.go:299': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/spendWindowCeiling.test.tsx:16|apps/bff/lens.go:530': {
    kind: 'LIVE',
  ...
  'apps/web/src/upstreamCitations.test.ts:56|apps/bff/billing.go:299': {
    kind: 'LIVE',
    fragment: 'happens at Stripe',
    why: 'the example that paragraph gives of a citation checkable from here — now checked, which is what it asked for',
  },
  'apps/web/src/upstreamCitations.test.ts:55|apps/bff/lens.go:530': {
    kind: 'LIVE',
    fragment: 'clampInt(r.URL.Query().Get("limit"), 20, 1, 200)',
  ...
  'apps/web/src/areas/docs/BFF-GAPS.md:14|apps/bff/lens.go:120': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/Members.tsx:76|apps/bff/lens.go:782': {
    kind: 'LIVE',
  ...
  'apps/web/src/areas/lens/Members.test.tsx:185|apps/bff/lens.go:782': {
    kind: 'LIVE',
    fragment: 'X-User-Email',
