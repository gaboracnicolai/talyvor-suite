 ...
 *
 * ⚠ NOT EVERY Go CITATION IS THE SAME CLASS, AND THE OTHER CLASS IS NOW CHECKED. `apps/bff/lens.go:521`
 * and `apps/bff/billing.go:299` name a file IN THIS REPOSITORY, so they are verifiable from here
