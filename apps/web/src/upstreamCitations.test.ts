 ...
 *
 * ⚠ NOT EVERY Go CITATION IS THE SAME CLASS, AND THE OTHER CLASS IS NOW CHECKED. `apps/bff/lens.go:511`
 ...
 * `TopUp.tsx:28` citation in the SAME PARENTHESIS was pinned and green. `pointerAudit` now
